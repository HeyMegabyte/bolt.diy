...
export const trustSchema = z.object({
  ...
  before_after_gallery: confSchema(
    z.array(
      z.object({
        before_url: z.string(),
        after_url: z.string(),
...
export const provenanceSchema = z.object({
  ...
  enrichmentPipeline: z.array(z.enum(['llm_research', 'google_places', 'owner_questionnaire'])),

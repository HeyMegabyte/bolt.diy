/**
 * Integrations tab — link out to `/dashboard/integrations` (no duplicate UI).
 */
import { ChangeDetectionStrategy, Component } from '@angular/core';
import { CommonModule } from '@angular/common';

@Component({
  selector: 'lib-integrations-tab',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CommonModule],
  template: `
    <h2 class="ps-h2">Integrations</h2>
    <p>
      Connect third-party services in
      <a

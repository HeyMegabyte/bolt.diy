...
const TEMPLATES: Record<string, TemplateShell> = {
  Restaurant: {
    ...
    color_strategy:
      'Warm tones: amber, orange, deep red. Dark backgrounds with warm accent highlights.',
    layout_notes:
      'Full-width hero with food image overlay. Menu as card grid. Map embed near bottom.',
    recommended_pages: [
      'index.html',
      'menu.html',
      'about.html',
  ...
  Salon: {
    ...
    layout_notes:
      'Glamorous hero with gradient overlay. Services as pricing cards. Team with circular photos.',
    recommended_pages: [
      'index.html',
      'services.html',
      'about.html',
  ...
  Legal: {
    ...
    layout_notes:
      'Commanding hero with firm tagline. Practice areas as icon cards. Attorneys in formal grid.',
    recommended_pages: [
      'index.html',
      'practice-areas.html',
      'attorneys.html',
  ...
  Medical: {
    ...
    layout_notes:
      'Clean hero with trust signals. Services with medical icons. Provider cards with credentials.',
    recommended_pages: [
      'index.html',
      'services.html',
      'providers.html',
  ...
  Tech: {
    ...
    color_strategy:
      'Modern tech: dark mode with vibrant gradients (indigo to purple). Neon accents.',
    layout_notes:
      'Hero with animated gradient. Features as icon grid. Pricing table. CTA with gradient button.',
    recommended_pages: [
      'index.html',
      'features.html',
      'about.html',
  ...
  Construction: {
    ...
    layout_notes:
      'Bold hero with project photo. Services as icon list. Portfolio gallery with before/after.',
    recommended_pages: [
      'index.html',
      'services.html',
      'portfolio.html',
  ...
  Fitness: {
    ...
    color_strategy:
      'High-energy: black with red/orange gradients. Bold typography. Action-oriented.',
    layout_notes:
      'Dynamic hero with energy feel. Programs as cards. Trainers with action shots. Pricing table.',
    recommended_pages: [
      'index.html',
      'programs.html',
      'trainers.html',
  ...
  'Real Estate': {
    ...
    layout_notes:
      'Property hero with search overlay. Listings as image cards. Agent profiles with stats.',
    recommended_pages: [
      'index.html',
      'listings.html',
      'about.html',
  ...
  Automotive: {
    ...
    layout_notes:
      'Hero with vehicle/shop imagery. Services as icon cards. Trust badges for certifications.',
    recommended_pages: [
      'index.html',
      'services.html',
      'about.html',
  ...
  Education: {
    ...
    color_strategy:
      'Academic: deep blue with bright yellow/gold accents. Inspiring and structured.',
  ...
  Financial: {
    ...
    color_strategy:
      'Financial trust: navy/slate with green (growth) accents. Conservative elegance.',
    layout_notes:
      'Authoritative hero with trust messaging. Services as detailed cards. Team with credentials.',
    recommended_pages: [
      'index.html',
      'services.html',
      'about.html',
  ...
  Café: {
    ...
    color_strategy:
      'Warm café: cream, brown, orange. Cozy and inviting with coffee-inspired tones.',
  ...
  Other: {
    ...
    layout_notes:
      'Strong hero with brand colors. Feature cards. Clean about section. Contact form.',
    recommended_pages: [
      'index.html',
      'about.html',
      'services.html',
...
export function matchCategory(businessType: string): TemplateCategory {
  ...
  const mappings: Array<[string[], TemplateCategory]> = [
    [
      ['restaurant', 'dining', 'eatery', 'grill', 'bistro', 'pizzeria', 'sushi', 'taco', 'bbq'],
      'Restaurant',
    ],
    ...
    [
      ['tech', 'software', 'saas', 'startup', 'digital', 'app', 'web development', 'it service'],
      'Tech',
    ],
    [
      [
    ...
    [
      ['financial', 'accounting', 'cpa', 'tax', 'insurance', 'invest', 'wealth', 'bank'],
      'Financial',
    ],
 ...
 */
export async function getOrCreateTemplate(env: Env, category: string): Promise<TemplateShell> {

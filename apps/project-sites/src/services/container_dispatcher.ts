...
const BINDING_BY_SLUG: Readonly<Record<string, keyof Env>> = {
  'anything-llm': 'APP_RUNTIME_ANYTHING_LLM',
  'appsmith': 'APP_RUNTIME_APPSMITH',
  'audiobookshelf': 'APP_RUNTIME_AUDIOBOOKSHELF',
  'bookstack': 'APP_RUNTIME_BOOKSTACK',
  'cal': 'APP_RUNTIME_CAL',
  'chromadb': 'APP_RUNTIME_CHROMADB',
  'code-server': 'APP_RUNTIME_CODE_SERVER',
  'comfyui': 'APP_RUNTIME_COMFYUI',
  'coqui-tts': 'APP_RUNTIME_COQUI_TTS',
  'directus': 'APP_RUNTIME_DIRECTUS',
  'drone': 'APP_RUNTIME_DRONE',
  'farfalle': 'APP_RUNTIME_FARFALLE',
  'flowise': 'APP_RUNTIME_FLOWISE',
  'focalboard': 'APP_RUNTIME_FOCALBOARD',
  'fooocus': 'APP_RUNTIME_FOOOCUS',
  'forgejo': 'APP_RUNTIME_FORGEJO',
  'freshrss': 'APP_RUNTIME_FRESHRSS',
  'ghost': 'APP_RUNTIME_GHOST',
  'gitea': 'APP_RUNTIME_GITEA',
  'grafana': 'APP_RUNTIME_GRAFANA',
  'healthchecks': 'APP_RUNTIME_HEALTHCHECKS',
  'immich': 'APP_RUNTIME_IMMICH',
  'invokeai': 'APP_RUNTIME_INVOKEAI',
  'jellyfin': 'APP_RUNTIME_JELLYFIN',
  'karakeep': 'APP_RUNTIME_KARAKEEP',
  'khoj': 'APP_RUNTIME_KHOJ',
  'langflow': 'APP_RUNTIME_LANGFLOW',
  'langfuse': 'APP_RUNTIME_LANGFUSE',
  'librechat': 'APP_RUNTIME_LIBRECHAT',
  'linkwarden': 'APP_RUNTIME_LINKWARDEN',
  'listmonk': 'APP_RUNTIME_LISTMONK',
  'litellm': 'APP_RUNTIME_LITELLM',
  'lobe-chat': 'APP_RUNTIME_LOBE_CHAT',
  'matomo': 'APP_RUNTIME_MATOMO',
  'mattermost': 'APP_RUNTIME_MATTERMOST',
  'mautic': 'APP_RUNTIME_MAUTIC',
  'memos': 'APP_RUNTIME_MEMOS',
  'miniflux': 'APP_RUNTIME_MINIFLUX',
  'morphic': 'APP_RUNTIME_MORPHIC',
  'n8n': 'APP_RUNTIME_N8N',
  'navidrome': 'APP_RUNTIME_NAVIDROME',
  'nextchat': 'APP_RUNTIME_NEXTCHAT',
  'nextcloud': 'APP_RUNTIME_NEXTCLOUD',
  ...
  'postiz': 'APP_RUNTIME_POSTIZ',
  'qdrant': 'APP_RUNTIME_QDRANT',
  'rocketchat': 'APP_RUNTIME_ROCKETCHAT',
  'sd-webui': 'APP_RUNTIME_SD_WEBUI',
  'searxng': 'APP_RUNTIME_SEARXNG',
  'sillytavern': 'APP_RUNTIME_SILLYTAVERN',
  'stirling-pdf': 'APP_RUNTIME_STIRLING_PDF',
  'tabby': 'APP_RUNTIME_TABBY',
  'umami': 'APP_RUNTIME_UMAMI',
  'uptime-kuma': 'APP_RUNTIME_UPTIME_KUMA',
  'vaultwarden': 'APP_RUNTIME_VAULTWARDEN',
  'vendure': 'APP_RUNTIME_VENDURE',
  'vikunja': 'APP_RUNTIME_VIKUNJA',
  'weaviate': 'APP_RUNTIME_WEAVIATE',
  'whishper': 'APP_RUNTIME_WHISHPER',
  'whisper-asr': 'APP_RUNTIME_WHISPER_ASR',
  'wikijs': 'APP_RUNTIME_WIKIJS',
};

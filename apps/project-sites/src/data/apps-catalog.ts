...
export const APPS_CATALOG: ReadonlyArray<CatalogApp> = [
  ...
  },
  {
    ...
    env: [
      ...
      {
        key: 'SECRET_KEY_BASE',
        description: '64-byte secret for Phoenix',
        required: true,
        auto: 'secret',
      },
      {
  ...
  // ── Knowledge ───────────────────────────────────────────────
  {
    ...
    env: [
      ...
      { key: 'UTILS_SECRET', description: '32-byte secret', required: true, auto: 'secret' },
      {
        ...
        description: 'R2 access key for file uploads',
        required: true,
        auto: 's3_url',
      },
  ...
  },
  {
    ...
    infra: ['sqlite', 'volume'],
    port: 5230,
    env: [{ key: 'MEMOS_MODE', description: 'demo|prod|dev', required: true, default: 'prod' }],
    memoryMB: 128,
    volumeMB: 128,
    estCostMonthly: 4,
  ...
  // ── Productivity ────────────────────────────────────────────
  {
    ...
    description:
      'Sprints, cycles, modules, OKRs. Self-hosted project management without the enterprise tax.',
  ...
  },
  {
    ...
    description:
      'Turn any Postgres / MySQL DB into a smart spreadsheet UI. Forms, kanban, gallery, calendar views.',
    category: 'productivity',
    ...
    env: [
      {
        key: 'NC_DB',
        description: 'Postgres URI (e.g. pg://user:pw@host:5432/db)',
        required: true,
        auto: 'postgres_url',
      },
      {
  ...
  },
  {
    ...
    description:
      'Self-hosted scheduling with Google/Outlook sync, payments, round-robin, workflows.',
    category: 'productivity',
  ...
  // ── Communication ───────────────────────────────────────────
  {
    ...
    description:
      'Team messaging, file sharing, integrations. Enterprise-grade, used by Tesla, NASA.',
  ...
  },
  {
    ...
    env: [
      {
        key: 'MONGO_URL',
        description: 'MongoDB URL — note: Rocket.Chat needs Mongo, this image bundles it',
        required: false,
      },
  ...
  // ── Developer ───────────────────────────────────────────────
  {
    ...
    description:
      'Run VS Code on a remote container, access from any device. Perfect for ChromeOS / iPad dev.',
    category: 'developer',
    image: 'codercom/code-server:latest',
    infra: ['volume'],
    port: 8080,
    env: [{ key: 'PASSWORD', description: 'Login password', required: true, auto: 'secret' }],
    memoryMB: 1024,
    volumeMB: 1024,
    estCostMonthly: 24,
  ...
  },
  {
    ...
    env: [
      ...
      },
      {
        ...
        description: 'Shared secret between server + runners',
        required: true,
        auto: 'secret',
      },
  ...
  // ── Privacy ─────────────────────────────────────────────────
  {
    ...
    description:
      'Rust rewrite of Bitwarden server, 1/10th the resources. Works with all Bitwarden clients.',
    category: 'privacy',
  ...
  },
  {
    ...
    description:
      'Full productivity suite: file sync, collaborative documents, video calls, mail, contacts.',
    category: 'privacy',
  ...
  },
  {
    ...
    description:
      'Save links, take screenshots, archive content. Open-source Pocket / Raindrop alternative.',
    category: 'privacy',
  ...
  },
  {
    ...
    env: [
      ...
      },
      {
        ...
        description: '32-byte key for credential encryption',
        required: true,
        auto: 'secret',
      },
  ...
  },
  {
    ...
    description:
      'Email drip, landing pages, lead scoring, A/B testing. The serious marketer alternative to HubSpot.',
    category: 'marketing',
  ...
  // ── Monitoring ──────────────────────────────────────────────
  {
    ...
    description:
      'HTTP / DNS / Ping / Steam / Postgres / Redis probes. Beautiful status pages. Single-container.',
    category: 'monitoring',
  ...
  },
  {
    ...
    description:
      'Pings on a schedule, alerts when they stop. Built for cron, backups, queue consumers.',
    category: 'monitoring',
  ...
  },
  {
    ...
    env: [
      { key: 'GF_DATABASE_TYPE', description: 'postgres', required: true, default: 'postgres' },
      {
        ...
        description: 'Postgres host:5432',
        required: true,
        auto: 'postgres_url',
      },
  ...
  },
  {
    ...
    description:
      'One UI for every model. Agents, plugins, multi-modal, code interpreter. ChatGPT-style polish.',
    category: 'ai',
  ...
  // ── Backend ─────────────────────────────────────────────────
  {
    ...
    description:
      'Database + auth + file storage + realtime + admin UI. Single 50MB executable, SQLite-backed.',
    category: 'backend',
  ...
  },
  {
    ...
    description:
      'Drag-drop UI builder for CRUD apps, dashboards, admin panels. Connects to any DB.',
    category: 'backend',
  ...
  },
  {
    ...
    description:
      'Newsletter + blog + paid memberships in one CMS. Stripe integration, beautiful themes.',
    category: 'backend',
  ...
  },
  {
    ...
    description:
      'TypeScript + GraphQL headless commerce platform — product catalog, orders, customers, payments, and a plugin system, with separate Admin + Shop APIs and an Admin UI at /admin. Self-hostable alternative to Shopify/commercetools. Scaffolded via `@vendure/create`, so it ships as a custom multi-stage Node build (no single run-out-of-box image) — the card is decorative until its AppRuntime subclass + Dockerfile are wired.',
    category: 'backend',
    image: 'node:20-bookworm-slim',
    dockerfile: 'https://docs.vendure.io/guides/deployment/using-docker/',
    composeRef: 'https://github.com/vendure-ecommerce/vendure/blob/master/docker-compose.yml',
    infra: ['postgres', 'redis', 's3'],
    port: 3000,
    env: [
      { key: 'DB_HOST', description: 'Postgres host', required: true, auto: 'postgres_url' },
      ...
      },
      {
        ...
        description: 'Initial superadmin login',
        required: true,
        default: 'superadmin',
      },
      {
      ...
      {
        key: 'COOKIE_SECRET',
        description: 'Random secret for signing session cookies',
        required: true,
        auto: 'secret',
      },
    ],
    ...
    volumeMB: 0,
    estCostMonthly: 18,
    homepage: 'https://vendure.io',
    repo: 'https://github.com/vendure-ecommerce/vendure',
    glyph: '🛒',
    license: 'MIT',
    tags: ['ecommerce', 'graphql', 'headless', 'commerce'],
    supported: false,
  },
  ...
  },
  {
    ...
    description:
      'Cross-device sync, mobile apps, podcast feeds. The Audible / Spotify alternative for owned media.',
    category: 'media',
  ...
  },
  {
    ...
    infra: ['volume'],
    port: 4533,
    env: [{ key: 'ND_BASEURL', description: 'Public URL', required: false, auto: 'public_url' }],
    memoryMB: 256,
    volumeMB: 1024,
    estCostMonthly: 8,
   ...
   */
  {
    ...
    env: [
      {
        key: 'STORAGE_DIR',
        description: 'Container storage path',
        required: true,
        default: '/app/server/storage',
      },
      {
        key: 'JWT_SECRET',
        description: '32-byte session signing secret',
        required: true,
        auto: 'secret',
      },
      {
        key: 'LLM_PROVIDER',
        description: 'Default LLM (openai/anthropic/ollama)',
        required: false,
        default: 'openai',
      },
      {
   ...
   */
  {
    ...
    env: [
      ...
      {
        key: 'BASE_URL',
        description: 'Override API base URL (LiteLLM/OpenAI-compat)',
        required: false,
      },
    ],
    memoryMB: 256,
   ...
   */
  {
    ...
    env: [
      {
        key: 'SILLYTAVERN_BASIC_AUTH',
        description: 'Enable basic auth (true/false)',
        required: false,
        default: 'true',
      },
      {
        key: 'SILLYTAVERN_USERNAME',
        description: 'Basic-auth username',
        required: false,
        default: 'admin',
      },
      {
        key: 'SILLYTAVERN_PASSWORD',
    ...
    env: [
      {
        ...
        description: 'API key to gate REST/gRPC',
        required: true,
        auto: 'secret',
      },
    ],
    ...
    env: [
      {
        ...
        description: 'Auth provider class',
        required: false,
   ...
   */
  {
    ...
    env: [
      {
        key: 'CLI_ARGS',
        description: 'Extra command-line args (e.g. --listen)',
        required: false,
        default: '--listen 0.0.0.0 --enable-cors-header',
      },
    ],
    memoryMB: 1024,
    volumeMB: 4096,
   ...
   */
  {
    ...
    env: [
      ...
      {
        key: 'WEBUI_FLAGS',
        description: 'Extra A1111 flags (e.g. --xformers)',
        required: false,
        default: '--xformers --listen',
      },
    ],
    memoryMB: 1024,
    volumeMB: 8192,
   ...
   */
  {
    ...
    env: [
      ...
      {
        key: 'ASR_ENGINE',
        description: 'openai_whisper / faster_whisper',
        required: true,
   ...
   */
  {
    ...
    env: [
      {
        key: 'PUBLIC_INTERNAL_API_HOST',
        description: 'Internal API hostname',
        required: false,
        default: 'http://127.0.0.1:8080',
      },
      {
        key: 'WHISPER_MODELS',
        description: 'Comma list (tiny,base,small)',
        required: false,
        default: 'tiny,base',
      },
    ],
    ...
    env: [
      {
        ...
        description: 'Must be "1" to accept license',
        required: true,
        default: '1',
      },
    ],
   ...
   */
  {
    ...
    env: [
      ...
      {
        key: 'SEARXNG_SECRET',
        description: 'Random 32-byte secret',
        required: true,
        auto: 'secret',
      },
    ],
   ...
   */
  {
    ...
    env: [
      ...
      {
        key: 'NEXTAUTH_SECRET',
        description: '32-byte NextAuth secret',
        required: true,
        auto: 'secret',
      },
   ...
   */
  {
    ...
    env: [
      ...
      {
        key: 'RUN_MIGRATIONS',
        description: 'Run DB migrations on boot',
        required: true,
        default: '1',
      },
      {
   ...
   */
  {
    ...
    env: [
      ...
      {
        key: 'CRON_MIN',
        description: 'Cron schedule (refresh cadence)',
        required: false,
        default: '13,43',
      },
    ],
   ...
   */
  {
    ...
    env: [
      ...
      {
        key: 'UPLOAD_LOCATION',
        description: 'Container upload path',
        required: true,
        default: '/photos',
      },
    ],

...
- [ ] **C.1 build_validators invariants live on prod** — required files (webmanifest/robots/humans/sitemap/security.txt/favicons), asset existence, meta 50-60 / 120-156, JSON-LD ≥4 accurate blocks, single H1, no banned-slop (`src/services/build_validators.ts`)

/**
 * ADMIN FEATURE VERIFICATION (P0-ADMIN) — POPULATED-RENDER + XSS for the two AG-GRID sections
 * (audit `/admin/audit`, ai-logs `/admin/ai-logs`). Unlike the `@for`-list sections, these render
 * rows via ag-grid, so the assertion is `[role="row"]` count ≥ 2 (a header row + ≥1 data row).

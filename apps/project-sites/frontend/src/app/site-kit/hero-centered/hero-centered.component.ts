  ...
  template: `
    <section
      ...
      <div style="position:relative;max-width:800px;margin:0 auto;">
        ...
        <h1 style="font-size:clamp(2.5rem,6vw,4.5rem);font-weight:800;
                   line-height:1.05;margin:0 0 1.5rem;letter-spacing:-.03em;
                   text-wrap:balance;">
          {{ heading }}
        </h1>
        <p style="font-size:1.2rem;line-height:1.75;opacity:.75;
...
export class SkHeroCenteredComponent {
  ...
  @Input() subheading = 'Design, build, and ship your next product — faster than you thought possible.';

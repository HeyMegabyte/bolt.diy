  ...
  template: `
    ...
    >
      ...
      <div style="max-width:1200px;margin:0 auto;padding:4rem 1.5rem 3rem;">
        <div style="display:grid;gap:3rem;grid-template-columns:2fr repeat(3,1fr);" class="sf-grid">
          ...
          <div>
            ...
            <p
              style="opacity:.55;font-size:.9rem;line-height:1.7;max-width:30ch;margin:0 0 1.5rem;"
            >
              {{ tagline }}
            </p>
          ...
          @for (group of groups; track group) {
            <div>
              ...
              <ul
                style="list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:.5rem;"
              >
      ...
      <div [style.borderTop]="'1px solid var(--ps-hairline,rgba(255,255,255,.06))'">
        <div
          style="max-width:1200px;margin:0 auto;padding:1.25rem 1.5rem;
...
export class SkSiteFooterComponent {
  ...
  // (@for renders nothing /  on socials + legalLinks). The consumer passes the

    ...
    @if (tiers.length) {
      ...
      >
        ...
        >
          ...
          "
              [style.background]="
                tier.highlighted ? 'rgba(0,229,255,0.08)' : 'rgba(244,244,255,0.04)'
              "
              [style.border]="
                tier.highlighted
                  ? '2px solid rgba(0,229,255,0.5)'
                  : '1px solid rgba(244,244,255,0.1)'
              "
          ...
          "
            ...
            "
                ...
                >
                @if (tier.period) {
                  <span style="color:rgba(244,244,255,0.4);font-size:0.82rem;margin-left:4px;"
                    >/ {{ tier.period }}</span
                  >
                }
              </div>
              ...
              "
                    [style.color]="
                      feature.included ? 'rgba(244,244,255,0.8)' : 'rgba(244,244,255,0.3)'
                    "
                  >
                    <!-- Check or cross -->
                    <svg
            ...
            "
                [style.background]="
                  tier.highlighted ? 'var(--ps-accent, #00e5ff)' : 'rgba(244,244,255,0.08)'
                "

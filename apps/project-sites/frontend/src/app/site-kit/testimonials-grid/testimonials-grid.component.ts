...
export interface Testimonial { quote: string; name: string; title: string; avatarSrc?: string; }
    ...
    <section
      ...
      <div style="max-width:1100px;margin:0 auto;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:1.5rem;">
          <figure *ngFor="let t of testimonials"
            ...
            <div [style.color]="'var(--ps-accent,#00e5ff)'"
                 ...
                 aria-label="5 stars">★★★★★</div>

            <blockquote style="font-size:1rem;line-height:1.7;margin:0 0 1.5rem;
                               font-style:italic;opacity:.85;">
              "{{ t.quote }}"
            </blockquote>

            <figcaption style="display:flex;align-items:center;gap:.875rem;">
              <img *ngIf="t.avatarSrc" [src]="t.avatarSrc" [alt]="t.name"
                   style="width:40px;height:40px;border-radius:50%;object-fit:cover;" />
              <div *ngIf="!t.avatarSrc"

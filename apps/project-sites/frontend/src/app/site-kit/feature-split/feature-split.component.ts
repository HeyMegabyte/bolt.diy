          ...
          @for (item of items; track item) {
            ...
            >
              ...
              <div style="direction:ltr;">
                ...
                <h3
                  style="font-size:clamp(1.5rem,3vw,2.25rem);font-weight:700;
                       margin:0 0 1rem;letter-spacing:-.02em;line-height:1.2;text-wrap:balance;"
                >
                  {{ item.heading }}
                </h3>
                <p style="font-size:1.05rem;line-height:1.75;opacity:.75;margin:0;">
                  {{ item.body }}
                </p>
              </div>
              <!-- Screenshot -->
              <div
                style="direction:ltr;border-radius:var(--ps-radius-xl,22px);overflow:hidden;
...
export class SkFeatureSplitComponent {
  ...
  // self-hides (). The consumer passes the business's REAL feature narrative +

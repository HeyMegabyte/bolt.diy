        ...
        >
          ...
          "
            ...
            "
              ...
              <!-- Body -->
              <div
                style="padding: 18px 18px 14px; flex: 1; display: flex; flex-direction: column; gap: 6px;"
              >
                <!-- Price row -->
                @if (listing.price || listing.priceLabel) {
                  <div
                    style="
                font-size: 1.2rem;
                font-weight: 900;
              ...
              "
                  >
                    @if (listing.price) {
                      <span>{{ listing.price | currency: 'USD' : 'symbol' : '1.0-0' }}</span>
                    }
                    @if (!listing.price && listing.priceLabel) {
            ...
            "
              ...
              "
                  >
                    <svg viewBox="0 0 16 16" width="12" height="12" aria-hidden="true">
                      <path
                        d="M8 1C5.24 1 3 3.24 3 6c0 3.75 5 9 5 9s5-5.25 5-9c0-2.76-2.24-5-5-5zm0 6.5c-.83 0-1.5-.67-1.5-1.5S7.17 4.5 8 4.5 9.5 5.17 9.5 6 8.83 7.5 8 7.5z"
                        fill="currentColor"
                      />
                    </svg>
                    {{ listing.location }}
              ...
              "
                  >
                    @for (d of listing.details; track d) {
                      <li
                        style="
...
export class ListingsGridComponent {
  ...
  // listings as real inventory. Empty by default → the <section> self-hides ().

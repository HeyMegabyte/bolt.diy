  ...
  template: `
    ...
    >
      ...
      <div style="position:relative;max-width:720px;margin:0 auto;">
        <h2
          style="font-size:clamp(2rem,4.5vw,3.25rem);font-weight:800;
        ...
        @if (footnote) {
          <p style="margin:1.5rem 0 0;font-size:.85rem;opacity:.6;">{{ footnote }}</p>
        }
      </div>
    </section>
  `,
...
export class SkCtaBandComponent {
  ...
  // real business site as fact. Empty → the <p> self-hides (="subheading"); the

  ...
  template: `
    ...
    >
      ...
      >
        ...
        <!-- Links -->
        @if (links.length) {
          <ul style="display:flex;gap:2rem;list-style:none;margin:0;padding:0;" role="list">
...
export class SkSiteNavbarComponent {
  ...
  // <ul> self-hides (). The consumer passes the business's REAL nav. (anti-fabrication mandate)
  @Input() links: NavLink[] = [];
}

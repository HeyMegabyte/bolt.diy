    ...
    <section
      ...
      <div style="max-width:1200px;margin:0 auto;display:grid;
        ...
        <div>
          ...
          <h1 style="font-size:clamp(2rem,4vw,3.25rem);font-weight:700;
                     line-height:1.1;margin:0 0 1.25rem;letter-spacing:-.02em;">
            {{ heading }}
          </h1>
          <p style="font-size:1.15rem;line-height:1.7;opacity:.8;margin:0 0 2rem;
                    max-width:42ch;">
            {{ subheading }}
          </p>
        ...
        <!-- Right: image -->
        <div style="border-radius:var(--ps-radius-xl,22px);overflow:hidden;
                    box-shadow:var(--ps-shadow-xl,0 20px 60px rgba(0,0,0,.4));">
          <img [src]="imageSrc" [alt]="imageAlt"
               style="width:100%;height:100%;object-fit:cover;display:block;
                      aspect-ratio:4/3;" loading="lazy" />
        </div>
      </div>
    </section>
  `,

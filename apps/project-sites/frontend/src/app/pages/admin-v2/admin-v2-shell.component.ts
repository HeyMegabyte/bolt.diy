...
export class AdminV2ShellComponent {
  ...
  protected readonly siteNav: NavItem[] = [
    ...
    { id: 'site-branches', label: 'Branches', link: '/admin/v2/site/branches', exact: false },
    { id: 'site-mcp', label: 'MCP Server', link: '/admin/v2/site/mcp', exact: false },
  ...
  protected readonly sysNav: NavItem[] = [
    ...
    { id: 'inbox', label: 'Inbox', link: '/admin/v2/inbox', exact: false },
    ...
    { id: 'content-freshness', label: 'Content Freshness', link: '/admin/v2/content-freshness', exact: false },

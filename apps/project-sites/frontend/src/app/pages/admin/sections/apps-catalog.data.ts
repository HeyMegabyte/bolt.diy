...
export const APPS_CATALOG: ReadonlyArray<CatalogApp> = [
  ...
  },
  {
    ...
    env: [
      ...
      { key: 'CLOUDFLARE_ACCOUNT_ID', description: 'CF Account ID for R2', required: true, auto: 'account_id' },
      { key: 'CLOUDFLARE_ACCESS_KEY', description: 'R2 Access Key ID', required: true, secret: true },
      { key: 'CLOUDFLARE_SECRET_ACCESS_KEY', description: 'R2 Secret Access Key', required: true, secret: true },
      ...
      { key: 'RESEND_API_KEY', description: 'Resend API key', required: false, secret: true },
      ...
      { key: 'TEMPORAL_API_KEY', description: 'Temporal Cloud API key', required: true, secret: true },
      // Short links (Dub — platform standard, replaces Kutt.it from reference deploy)
      { key: 'DUB_TOKEN', description: 'Dub.co API token for short links', required: false, secret: true },
      ...
      { key: 'X_API_KEY', description: 'X (Twitter) API key', required: false, secret: true },
      { key: 'X_API_SECRET', description: 'X (Twitter) API secret', required: false, secret: true },
      { key: 'LINKEDIN_CLIENT_ID', description: 'LinkedIn OAuth client ID', required: false, secret: true },
      { key: 'LINKEDIN_CLIENT_SECRET', description: 'LinkedIn OAuth client secret', required: false, secret: true },
      { key: 'FACEBOOK_APP_ID', description: 'Facebook App ID', required: false, secret: true },
      { key: 'FACEBOOK_APP_SECRET', description: 'Facebook App secret', required: false, secret: true },
      { key: 'YOUTUBE_CLIENT_ID', description: 'YouTube/Google OAuth client ID', required: false, secret: true },
      { key: 'YOUTUBE_CLIENT_SECRET', description: 'YouTube/Google OAuth client secret', required: false, secret: true },
      { key: 'TIKTOK_CLIENT_ID', description: 'TikTok client ID', required: false, secret: true },
      { key: 'TIKTOK_CLIENT_SECRET', description: 'TikTok client secret', required: false, secret: true },
      { key: 'REDDIT_CLIENT_ID', description: 'Reddit API client ID', required: false, secret: true },
      { key: 'REDDIT_CLIENT_SECRET', description: 'Reddit API client secret', required: false, secret: true },
      { key: 'PINTEREST_CLIENT_ID', description: 'Pinterest client ID', required: false, secret: true },
      { key: 'PINTEREST_CLIENT_SECRET', description: 'Pinterest client secret', required: false, secret: true },
      { key: 'DISCORD_CLIENT_ID', description: 'Discord OAuth client ID', required: false, secret: true },
      { key: 'DISCORD_CLIENT_SECRET', description: 'Discord OAuth client secret', required: false, secret: true },
      { key: 'DISCORD_BOT_TOKEN_ID', description: 'Discord bot token', required: false, secret: true },
      { key: 'SLACK_ID', description: 'Slack app ID', required: false, secret: true },
      { key: 'SLACK_SECRET', description: 'Slack app secret', required: false, secret: true },
      { key: 'SLACK_SIGNING_SECRET', description: 'Slack signing secret', required: false, secret: true },
      { key: 'DRIBBBLE_CLIENT_ID', description: 'Dribbble OAuth client ID', required: false, secret: true },
      { key: 'DRIBBBLE_CLIENT_SECRET', description: 'Dribbble OAuth client secret', required: false, secret: true },
      { key: 'GITHUB_CLIENT_ID', description: 'GitHub OAuth client ID (sign-in only)', required: false, secret: true },
      { key: 'GITHUB_CLIENT_SECRET', description: 'GitHub OAuth client secret', required: false, secret: true },
      { key: 'BEEHIIVE_API_KEY', description: 'Beehiiv newsletter API key', required: false, secret: true },
      { key: 'BEEHIIVE_PUBLICATION_ID', description: 'Beehiiv publication ID', required: false, secret: true },
      { key: 'TELEGRAM_TOKEN', description: 'Telegram bot token', required: false, secret: true },
      ...
      { key: 'NEXT_PUBLIC_SENTRY_DSN', description: 'Sentry DSN (dedicated postiz project)', required: false },
    ],
    memoryMB: 1024,
    estCostMonthly: 24,

    ...
    <div class="p-7 flex-1 overflow-y-auto animate-fade-in max-md:p-4 space-y-6" [class.agents--compact]="compact()" data-testid="ai-endpoints-page">
                ...
                <div class="url-row">
                  ...
                  @if (editingId() === e.id) {
                    <input
                      ...
                      (ngModelChange)="inlineEdit.update(d => ({ ...d, slug: $event }))"
                      maxlength="64"
                  ...
                  <div class="actions">
                    ...
                    <div class="more-wrap">
                      <button
                        ...
                        [attr.title]="'More actions for ' + e.endpoint_slug"
            ...
            <div>
              ...
              <div class="url-row">
                ...
                <input
                  ...
                  (ngModelChange)="createDraft.update(d => ({ ...d, slug: $event }))"
                  maxlength="64"
      ...
      @if (quickTesting(); as t) {
        <section class="card border border-primary/40">
          ...
          <textarea hlmInput [multiline]="true" class="w-full font-mono text-[0.72rem]" rows="5" aria-label="Request body (JSON)" [(ngModel)]="testBody"></textarea>

  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'site/editor',
        loadComponent: () =>
          import('./pages/admin-v2/sections/site-editor.component').then((m) => m.V2SiteEditorComponent),
      },
      {
        path: 'site/forms',
        loadComponent: () =>
          import('./pages/admin-v2/sections/site-forms.component').then((m) => m.V2SiteFormsComponent),
      },
      {
        path: 'site/files',
        loadComponent: () =>
          import('./pages/admin-v2/sections/site-files.component').then((m) => m.V2SiteFilesComponent),
      },
      {
        path: 'site/domains',
        loadComponent: () =>
      ...
      },
      {
        path: 'site/snapshots',
        loadComponent: () =>
          import('./pages/admin-v2/sections/site-snapshots.component').then((m) => m.V2SiteSnapshotsComponent),
      },
      {
        path: 'site/ai-logs',
        loadComponent: () =>
          import('./pages/admin-v2/sections/site-ai-logs.component').then((m) => m.V2SiteAiLogsComponent),
      },
      {
        path: 'site/ai-endpoints',
        loadComponent: () =>

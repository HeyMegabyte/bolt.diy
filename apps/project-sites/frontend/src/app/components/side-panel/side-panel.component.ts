...
@Component({
  ...
  styles: [`
    ...
    .sp-panel {
      ...
      border-left: 1px solid color-mix(in oklch, oklch(0.78 0.18 220) 22%, transparent);
      box-shadow: var(--ps-shadow-xl, 0 24px 64px rgba(0, 0, 0, 0.55));
      display: flex; flex-direction: column;
      animation: sp-slide-in var(--ps-dur-slow, 380ms) var(--ps-ease-emphasized, cubic-bezier(0.16, 1, 0.3, 1)) both;
    }
    ...
    .sp-close:hover { background: rgba(255, 255, 255, 0.07); color: #fff; }

...
- [ ] **0.4 Propagate the decision** to `DECISIONS.md`, `SCOPE.md`, `apps/project-sites/CLAUDE.md` (+ frontend CLAUDE.md): AI Agents removed → Functions on WfP; add to "Removed — never reintroduce" with the ADR link.
